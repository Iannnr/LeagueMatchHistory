...
public class TinyDB {
    ...
    public ArrayList<Long> getListLong(String key) {
        String[] myLongList = TextUtils.split(preferences.getString(key, ""), "‚‗‚");
        ArrayList<String> arrayToList = new ArrayList<String>(Arrays.asList(myLongList));
...
//    }
    ...
    public void putListLong(String key, ArrayList<Long> longList) {
        checkForNullKey(key);
        Double[] myLongList = longList.toArray(new Double[longList.size()]);
