...
/**
 * Created by Ian on 05/07/2016.
 */
public class OfflineDatabaseAdapter {

    databaseHelper dbHelper;

    public OfflineDatabaseAdapter(Context context) {
    ...
    public int getSize()
    {
        ...
        static class databaseHelper extends SQLiteOpenHelper {
            private static final String DATABASE_NAME = "myOfflineDatabase";
            private static final String TABLE_NAME = "myOfflineTable";
