...
public class httpConnect {
    ...
    public String getJSONFromUrl(String url, String my_token_string) {
        ...
        try {
            ...
            restConnection.setRequestProperty("X-ZUMO-AUTH", my_token_string);
